...
<tiles:insertDefinition name="catalog">
	<tiles:putAttribute name="title" value="Danh mục hình thức gia công" />
	<tiles:putAttribute name="formInf">
		<spring:url value="/stepType" var="formAction" />
	...
	<tiles:putAttribute name="catDetail" cascade="true">
		<form:hidden path="stepType.id" id="id"/>
				<div class="Row">
		            <div class="label-static col-md-2 col-lg-2 col-sm-12 col-xs-12">Mã<font color="red">*</font></div>
		            <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
		            	<form:input path = "stepType.code" cssClass="required" title="Mã không được để trống"/>
		            </div>
		            <div class="col-md-2 col-lg-2 col-sm-12 col-xs-12"></div>
		            <div class="label-static col-md-2 col-lg-2 col-sm-12 col-xs-12">Tên<font color="red">*</font></div>
		            <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
		            	<form:input path = "stepType.name" cssClass="required" title="Tên không được để trống"/>
		            </div>
		        </div>
		        <div class="Row">
		            <div class="label-static col-md-2 col-lg-2 col-sm-12 col-xs-12">Mô tả<font color="red">*</font></div>
		            <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
		            	<form:input path = "stepType.description" cssClass="required" title="mô tả không được để trống"/>
		            </div>     
		        </div>
	</tiles:putAttribute>
	</form:form>
